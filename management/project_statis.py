...
from project.models import Project,\
    ProjectInvestData
from prostatis.models import DayStatis,ProjectDayDetail,ProjectStatis
import logging
import time
logger = logging.getLogger("daycount")
class Command(BaseCommand):#定时任务
    def handle(self, *args, **options):
        ...
        cursor.execute("select a.project_id, a.source, sum(a.settle_amount) as sumofsettle, \
                            sum(a.return_amount) as sumofret from project_projectinvestdata a \
