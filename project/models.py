...
class Project(models.Model):
    ...
    audituser=models.ForeignKey(User,on_delete=models.PROTECT,related_name="auditman",verbose_name="审核人",blank=True,null=True)
    ...
    settle_detail= models.CharField("结算详情", max_length=300,blank=True,null=True)
